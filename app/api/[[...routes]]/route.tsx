...
let backup;
const collection = `https://testnets.opensea.io/assets/base-sepolia/${process.env.NFT_CONTRACT}`;
...
app.frame("/", async (c) => {
  ...
  try {
    ...
    return c.res({
      ...
      intents: [
        <Button action={quiz.a.path}>A</Button>,
        <Button action={quiz.a.path}>B</Button>,
        <Button action={quiz.c.path}>C</Button>,
      ],
    });
  } catch (error) {
...
app.frame("/offers", async (c) => {
  ...
  return c.res({
    ...
    intents: [
      <Button.Transaction action="/finish2" target="/mint10">
        10x
      </Button.Transaction>,
      <Button.Transaction action="/finish2" target="/mint25">
        25x
      </Button.Transaction>,
      <Button.Transaction action="/finish2" target="/mint100">
        100x
      </Button.Transaction>,
    ],
  });
